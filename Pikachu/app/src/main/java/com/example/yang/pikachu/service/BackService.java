package com.example.yang.pikachu.service;
...
import com.example.yang.pikachu.util.NotiReceiver;
import com.example.yang.pikachu.view.BasePetView;
import com.example.yang.pikachu.view.PikachuView;
...
//                    petView.setUntouchable(true);
                ...
                else if(petView.getTouchAnimPosi()) {
                    petView.startPosiAnimation();
//                    petView.setUntouchable(true);
                }
//                else {
